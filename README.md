...
## How to use
MATLAB codes for VEM-FPM are available in the folder "VEM_FPM". Simply run "VEM_FPM_main.m" to begin reconstrucion. The codes were tested on a desktop, running Windows 11 professional OS, with a CPU of Intel Core i9-12900K, 3.2Hz; a GPU of NVIDIA GeForce RTX 3090.
